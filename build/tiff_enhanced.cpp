...
tiff_file* tiff_file::generate() {
	...
	GENERATE_VAR(entry_count, ::g->entry_count.generate({ 12 }));
	...
	GENERATE_VAR(t_comp_value, ::g->t_comp_value.generate({ 1, 5, 7, 8, 32773 }));
	...
	GENERATE_VAR(t_soff_value, ::g->t_soff_value.generate({ 174 }));
	...
	GENERATE_VAR(t_sbc_value, ::g->t_sbc_value.generate({ 64 }));
	...
	GENERATE_VAR(t_xres_offset, ::g->t_xres_offset.generate({ 158 }));
	...
	GENERATE_VAR(t_yres_offset, ::g->t_yres_offset.generate({ 166 }));
